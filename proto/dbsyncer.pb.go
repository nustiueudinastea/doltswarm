...
type RequestHeadRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *RequestHeadRequest) Reset() {
	*x = RequestHeadRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestHeadRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestHeadRequest) ProtoMessage() {}

func (x *RequestHeadRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_dbsyncer_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestHeadRequest.ProtoReflect.Descriptor instead.
func (*RequestHeadRequest) Descriptor() ([]byte, []int) {
	return file_proto_dbsyncer_proto_rawDescGZIP(), []int{2}
}

type RequestHeadResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RequestHeadResponse) Reset() {
	*x = RequestHeadResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestHeadResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestHeadResponse) ProtoMessage() {}

func (x *RequestHeadResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_dbsyncer_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestHeadResponse.ProtoReflect.Descriptor instead.
func (*RequestHeadResponse) Descriptor() ([]byte, []int) {
	return file_proto_dbsyncer_proto_rawDescGZIP(), []int{3}
}

func (x *RequestHeadResponse) GetHead() string {
	if x != nil {
		return x.Head
	}
	return ""
...
var file_proto_dbsyncer_proto_rawDesc = []byte{
	...
	,
	...
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x65, 0x61, 0x64, 0x52, 0x65, 0x73, 0x70,
...
var file_proto_dbsyncer_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_dbsyncer_proto_goTypes = []interface{}{
	...
	(*RequestHeadRequest)(nil),    // 2: proto.RequestHeadRequest
	(*RequestHeadResponse)(nil),   // 3: proto.RequestHeadResponse
}
var file_proto_dbsyncer_proto_depIdxs = []int32{
	0, // 0: proto.DBSyncer.AdvertiseHead:input_type -> proto.AdvertiseHeadRequest
	2, // 1: proto.DBSyncer.RequestHead:input_type -> proto.RequestHeadRequest
	1, // 2: proto.DBSyncer.AdvertiseHead:output_type -> proto.AdvertiseHeadResponse
	3, // 3: proto.DBSyncer.RequestHead:output_type -> proto.RequestHeadResponse
...
func file_proto_dbsyncer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_dbsyncer_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestHeadRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_dbsyncer_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestHeadResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
